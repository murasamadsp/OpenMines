#!/usr/bin/env python3
"""Static Rust soundness audit: unsafe allowlist + adjacent atomics.
Merged from ub-audit-unsafe.py and ub-audit-atomics.py.
"""
...
# === Adjacent atomics ===
print("==> Checking hot adjacent atomics")
