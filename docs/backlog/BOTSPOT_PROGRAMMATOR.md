# BotSpot programmator — анализ и план
...
- `crates/server/openmines-server/src/game/actors/botspot.rs`: `BotSpotMarker`, `BotSpotData` (id=-owner_id,
...
- Игроковый `programmator_system` (`crates/server/openmines-server/src/game/actors/programmator.rs:546`):
