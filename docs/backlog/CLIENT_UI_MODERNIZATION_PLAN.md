...
Подробный чеклист по фазам: `docs/reference/CLIENT_UI_TEST_MATRIX.md`.
...
2. Добавить lightweight UI audit checklist в документацию:
   ...
   - blocking defects.
   Базовый чеклист: `docs/reference/CLIENT_UI_TEST_MATRIX.md`.
...
- продолжать использовать `crates/openmines-server/src/net/session/ui/horb.rs`;
