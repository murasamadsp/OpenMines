...
- **КЛИЕНТ ИДЕАЛЕН** — клиент по определению корректен и является эталоном. Запрещено объяснять любой баг «проблемой на стороне клиента». Если что-то не работает (коннект, логин, геймплей) — причина ВСЕГДА на сервере. Искать и чинить только в `server/`.
- **КЛИЕНТ ИДЕАЛЕН** — клиент по определению корректен и является эталоном. Запрещено объяснять любой баг «проблемой на стороне клиента». Если что-то не работает (коннект, логин, геймплей) — причина ВСЕГДА на сервере. Искать и чинить только в `server/`.
